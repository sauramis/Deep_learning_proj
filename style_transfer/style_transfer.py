...
def define_module_args():
	...
	main_arg_parser.add_argument("--transfer-method", help="type of style transfer", type=str, required=True, default="original")
	main_arg_parser.add_argument("--epochs", help="number of epochs for evaluation", type=int, default=10)
	main_arg_parser.add_argument("--style-image", help="path to the style image", type=str, required=True, default="images/style-images/mosaic.jpg")
	main_arg_parser.add_argument("--segmentation", help="segment the content image", type=bool, default=False)
